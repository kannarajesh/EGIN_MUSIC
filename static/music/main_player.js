...
new Vue({
        ...
        return {
            ...
            playlist: {
                ...
                tracks: [{
                    ...
                    duration: 274,
		    audio_path : 'http://192.168.1.2:8000/static/music/Music_S/Vaathi%20Raid-Masstamilan.In.mp3',
                    cover: {
                    ...
                    duration: 300,
			audio_path : 'http://192.168.1.6:8000/static/music/Music_S/Vaathi%20Raid-Masstamilan.In.mp3',
                    cover: {
    ...
    methods: {
        test: function(id) {
		audio : new Audio(this.currentTrack.audio_path);
	//	var audio = "audio variable"
		console.log(audio+" AND inside test")
		if (id === "play") {
		console.log(audio+" Playing")
			audio.play()
		}
		if (id === "pause") {
		console.log(audio+id+" Pause")
			audio.pause()
		}
		if (id === "stop") {
